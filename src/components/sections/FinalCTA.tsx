...
export function FinalCTA() {
  return (
    <Section className="pb-24">
      <Container>
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-indigo-500/15 via-slate-900 to-cyan-500/10 p-8 sm:p-10 lg:p-12">
